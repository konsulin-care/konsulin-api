...
const (
	...
	ErrDevAuthAnonymousTokenMissing = "anonymous session token missing"
	ErrDevAuthSupertokensSessionMissing = "supertokens session missing (cookie session required)"
