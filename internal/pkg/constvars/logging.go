...
const (
	...
	LoggingSearchTermKey = "search_term"
)
...
const (
	LoggingCitiesCountKey = "cities_count"
)
...
const (
	...
	LoggingAppointmentStartTimeKey = "appointment_start_time"
	LoggingAppointmentEndTimeKey   = "appointment_end_time"
)
...
const (
	LoggingAssessmentCountKey = "assessments_count"
	LoggingAssessmentIDKey    = "assessment_id"
)

const (
	LoggingAssessmentResponseCountKey = "assessment_responses_count"
	LoggingAssessmentResponseIDKey    = "assessment_response_id"
)
...
const (
	LoggingRoleIDKey    = "role_id"
	LoggingRoleNameKey  = "role_name"
	LoggingRoleCountKey = "roles_count"
)
...
const (
	LoggingJournalIDKey = "journal_id"
)

const (
	LoggingCityIDKey = "city_id"
)
...
const (
	LoggingClinicianCountKey = "clinicians_count"
	LoggingClinicianIDKey    = "clinician_id"
)

const (
	LoggingEducationLevelCountKey = "education_levels_count"
...
const (
	...
	LoggingGenderCodeKey  = "genders_cde"
)
