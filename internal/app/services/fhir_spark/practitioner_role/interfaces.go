...
type PractitionerRoleFhirClient interface {
	...
	FindPractitionerRoleByCustomRequest(ctx context.Context, request *requests.FindAllCliniciansByClinicID) ([]responses.PractitionerRole, error)
	...
	FindPractitionerRoleByPractitionerIDAndName(ctx context.Context, request *requests.FindClinicianByClinicianID) ([]responses.PractitionerRole, error)
